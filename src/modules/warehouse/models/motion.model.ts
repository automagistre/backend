...
import {
  MotionSourceUnion,
  MotionSourceType as MotionSourceUnionType,
...
export class MotionModel {
  ...
  @Field(() => Int, {
    description: 'Количество (положительное = приход, отрицательное = расход)',
  })
  quantity: number;
  ...
  @Field(() => MotionSourceUnion, {
    nullable: true,
    description: 'Источник движения (резолвится автоматически)',
  })
